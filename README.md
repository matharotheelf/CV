...
|Optimisation of Evolutionary Algorithms | Multi-objective optimisation algorithm rely on hard coded parameters to operate. I automated the varying of these hard-coded parameters to test which combinations of them provided the best performance. | 6 months | Diamond Light Source Online Optimiser, Python | None |
